	...
	<?php require_once("entete.php"); ?>
		<div id="settings_section">
			<div id="second_div">
				...
				<li class="list-group-item d-flex justify-content-between align-items-center"><p class="lead">name: <span class="badge badge-primary badge-pill"><?= $_SESSION['user_name'];?></span></p></li>
				<li class="list-group-item d-flex justify-content-between align-items-center"><p class="lead">length of cycle: <span class="badge badge-primary badge-pill"><?= $_SESSION['cycle']; ?></span> jours</p></li>
				<li class="list-group-item d-flex justify-content-between align-items-center"><p class="lead">duration of menstruations : <span class="badge badge-primary badge-pill"><?= $_SESSION['duree'];?></span> jours</p></li>
				</ul>
